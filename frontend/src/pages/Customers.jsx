...
import './Styles.css';
import { FaTools, FaUndo, FaTrashAlt, FaShoppingCart, FaBoxes, FaChartLine, FaRegUser, FaListUl, FaEdit } from "react-icons/fa";
...
<div style={{display:"flex", flexDirection:"row", gap:"20px"}}>
  <h5><strong>List of Customers</strong></h5>    
      <select
...
<div className="topbar-inventory-box mt-2" style={{ maxHeight: 'calc(100vh - 250px)', overflowY: 'auto' }}>
...
{isAddCustomerModalOpen && (
  <div className="custom-modal-backdrop">
    ...
    <hr />
      <div className="mb-1">
        <label className="form-label"><strong>Customer Name:</strong></label>
        <input
          type="text"
          className="form-control"
          style={{width: "360px"}}
      ...
      <div className="mb-1">
        <label className="form-label"><strong>Shipping Address:</strong></label>
        <input
          type="text"
          className="form-control"
          style={{width: "360px"}}
      ...
      <div className="mb-1">
        <label className="form-label"><strong>Bank Details:</strong></label>
        <input
          type="text"
          className="form-control"
          style={{width: "360px"}}
      ...
      <div className="mb-1">
        <label className="form-label"><strong>TIN:</strong></label>
        <input
          type="text"
          className="form-control"
          style={{width: "360px"}}
    ...
    <div className="custom-modal" style={{ width: "400px" }}>
      ...
      <div className="mb-1">
        ...
        <input
          ...
          onChange={(e) => setSelectedEditCustomer({ ...selectedEditCustomer, name: e.target.value })}
        />
      </div>
      ...
      <div className="mb-1">
        ...
        <input
          ...
          onChange={(e) => setSelectedEditCustomer({ ...selectedEditCustomer, billing_address: e.target.value })}
        />
      </div>
      ...
      <div className="mb-1">
        ...
        <input
          ...
          onChange={(e) => setSelectedEditCustomer({ ...selectedEditCustomer, shipping_address: e.target.value })}
        />
      </div>
      ...
      <div className="mb-1">
        ...
        <input
          ...
          onChange={(e) => setSelectedEditCustomer({ ...selectedEditCustomer, bank_details: e.target.value })}
        />
      </div>
      ...
      <div className="mb-1">
        ...
        <input
          ...
          onChange={(e) => setSelectedEditCustomer({ ...selectedEditCustomer, tin: e.target.value })}
        />
      </div>
      ...
      <div className="mb-1">
        ...
        <select
          ...
          onChange={(e) => setSelectedEditCustomer({ ...selectedEditCustomer, status: e.target.value })}
        >
          <option value="Active">Active</option>
          <option value="Inactive">Inactive</option>
        </select>
