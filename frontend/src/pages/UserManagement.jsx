...
import { FaTools, FaEdit, FaTrash, FaShoppingCart, FaBoxes, FaChartLine, FaRegUser, FaListUl, FaUndo, FaTrashAlt } from "react-icons/fa";
...
<label><strong>Password</strong> (leave blank to keep current):</label>
